...
public class BillableServiceControllerIT extends ITBase {
  ...
  public void getGetBillableServicesOk() {
    ...
    RestAssured.given()
        ...
        .get("http://localhost:9001/billable-services")
        .then()
        .log().all()
        .statusCode(200);
  ...
  public void getGetBillableServicesByIdOk() {
    ...
    RestAssured.given()
        .accept(ContentType.JSON)
        .contentType(ContentType.JSON)
        .get("http://localhost:9001/billable-services/1")
        .then()
        .statusCode(200)
  ...
  public void getGetBillableServicesByNonExistentIdThrowsNotFoundError() {
    ...
    RestAssured.given()
        .accept(ContentType.JSON)
        .contentType(ContentType.JSON)
        .get("http://localhost:9001/billable-services/100")
        .then()
        .statusCode(404)
        .body("status", is(404));
  ...
  public void whenCreateBillableServiceOk() {
    RestAssured.given()
        ...
        .body(BillableService.builder().name("New service")
            ...
            .build())
        .post("http://localhost:9001/billable-services")
        .then()
        .statusCode(201);
  ...
  public void whenDeleteBillableServiceOk() {
    ...
    RestAssured.given()
        .accept(ContentType.JSON)
        .contentType(ContentType.JSON)
        .delete("http://localhost:9001/billable-services/" + billableService.getId())
        .then()
        .statusCode(200);
  ...
  public void whenUpdateBillableServiceOk() {
    ...
    RestAssured.given()
        ...
        .put("http://localhost:9001/billable-services/" + billableService.getId())
        .then()
        .statusCode(200);
