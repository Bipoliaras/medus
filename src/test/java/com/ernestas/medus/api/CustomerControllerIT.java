...
public class CustomerControllerIT extends ITBase {
  ...
  public void whenGetCustomersOk() {
    ...
    RestAssured.given()
        ...
        .get("http://localhost:9001/customers")
        .then()
        .log()
        .all();
  ...
  public void whenDeleteCustomerByIdOk() {
    ...
    RestAssured.given()
        .accept(ContentType.JSON)
        .contentType(ContentType.JSON)
        .delete("http://localhost:9001/customers/" + customer.getId())
        .then()
        .statusCode(200);
  ...
  public void whenDeleteAccountByIdOk() {
    ...
    RestAssured.given()
        .accept(ContentType.JSON)
        .contentType(ContentType.JSON)
        .delete("http://localhost:9001/customers/2/accounts/8")
        .then()
        .statusCode(200);
  }
  ...
  public void whenDeleteAccountByNonExistentAccountIdThrowsNotFoundException() {
    ...
    RestAssured.given()
        .accept(ContentType.JSON)
        .contentType(ContentType.JSON)
        .delete("http://localhost:9001/customers/2/accounts/100")
        .then()
        .statusCode(404);
  }
  ...
  public void whenDeleteAccountByNonExistentCustomerIdThrowsNotFoundException() {
    ...
    RestAssured.given()
        .accept(ContentType.JSON)
        .contentType(ContentType.JSON)
        .delete("http://localhost:9001/customers/200/accounts/6")
        .then()
        .statusCode(404);
  }
  ...
  public void whenUpdateCustomerOk() {
    ...
    RestAssured.given()
        ...
        .body(Customer.builder()
            ...
            .personalCode("35712038328")
            .build())
        .put("http://localhost:9001/customers/2")
        .then()
        .statusCode(200);
  ...
  public void whenGetCustomerByIdOk() {
    ...
    RestAssured.given()
        .accept(ContentType.JSON)
        .contentType(ContentType.JSON)
        .get("http://localhost:9001/customers/2")
        .then()
        .statusCode(200);
  ...
  public void whenGetNonExistentCustomerByIdThrowsNotFoundError() {
    ...
    RestAssured.given()
        .accept(ContentType.JSON)
        .contentType(ContentType.JSON)
        .get("http://localhost:9001/customers/100")
        .then()
        .statusCode(404)
        .body("status", is(404))
  ...
  public void whenAddAccountOk() {
    ...
    RestAssured.given()
        ...
        .accept(ContentType.JSON)
        .contentType(ContentType.JSON)
        .post("http://localhost:9001/customers/2/accounts")
        .then()
        .statusCode(201);
  ...
  public void whenCreateCustomerOk() {
    RestAssured.given()
        ...
        .accept(ContentType.JSON)
        .contentType(ContentType.JSON)
        .post("http://localhost:9001/customers")
        .then()
        .statusCode(201);
